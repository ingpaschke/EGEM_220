...
/* Modern gemlib provides aes_global[] — alias as GLOBAL for E_GEM internals */
#define GLOBAL		aes_global

/* INTIN/INTOUT/ADDRIN not needed — the 4 functions that used them
   (objc_sysvar, appl_search, appl_getinfo, wind_xget) have been
   rewritten to use mt_* calls directly. */
...
/* Rename to avoid conflict with NetHack decl.c multi */
#ifdef NETHACK_BOOLEAN
#define multi e_gem_multi
#endif
...
#define driver_avaiable driver_available
